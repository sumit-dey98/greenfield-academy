...
// Bulk-replaces the entire period list in one transaction 
export function replacePeriods(periodsList) {
  return apiFetch("/admin/periods", { method: "POST", body: periodsList })
}
